<script lang="ts">
  let blobMovementToggle = $state(0);
...
<style lang="postcss">
  ...
  .move-1 {
    transform: translate(20vw, 20vh) scale(3);
  }
  ...
  .move-4 {
    transform: translate(70vw, 70vh) scale(1.5);
  }
  ...
  .move-5 {
    transform: translate(35vw, 40vh) scale(2);
  }
  ...
  .move-6 {
    transform: translate(55vw, 60vh) scale(2.2);
  }
</style>
